...
RCT_EXTERN_METHOD(resizeTopTwoThirds)
RCT_EXTERN_METHOD(resizeBottomTwoThirds)
RCT_EXTERN_METHOD(resizeMiddleTwoThirds)
RCT_EXTERN_METHOD(resizeLeftThreeFourths)
RCT_EXTERN_METHOD(resizeRightThreeFourths)
RCT_EXTERN_METHOD(resizeTopThreeFourths)
RCT_EXTERN_METHOD(resizeBottomThreeFourths)
RCT_EXTERN_METHOD(resizeMiddleThreeFourths)
